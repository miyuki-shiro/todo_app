    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          const Text("Add Todo Here:", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          Card(
          ...
          const SizedBox(height: 20),
          const Text("Your Todos", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          Expanded(
            child: StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<List<TodoModel>> snapshot) {
                if (snapshot.connectionState == ConnectionState.active) {
                  if (snapshot.data.isEmpty) {
                    return const Center(child: Text("You don't have any unfinished Todos"));
                  }
